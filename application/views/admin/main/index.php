<script>
	...
	var queryParam   = page+"/"+sortby+"?q="+searchstring;
  	get_list(queryParam);	 
	...
	function sorting(field,sort){
			sortby =field+"-"+sort;
			url= page+"/"+sortby+"?q="+searchstring;
			get_list(url);
	}
</script> 
<div class="container_header">
    ...
    <div class='search_panel' style="float: left;">
        <div style="float:left; padding-left:10px;">
            <form action="<?= $this->config->item('admin_url') ?>/<?= $this->name ?>/approval" method="get">	
                        
                <input name="q" id="q" type="text" value="<?= set_value('q',''); ?>" placeholder="Search action, module, log" class="mystyles_textbox">
